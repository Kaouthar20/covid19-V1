...
export class CarouselComponent implements OnInit {
  ...
  carouselElements= [

    {
      ...
      description:'Disclaimer: National updates are published at different times and in different time zones. This, and the time ECDC needs to process these data, ...'
    },
    {
    ...
    },
    {
      ...
      description:'Geneticists said more evidence is needed to determine if a common ...'
    },
    {
      ...
      description:'Parts of Beijing have reimposed lockdown measures after a cluster of locally transmitted ...'
    },
    {
      ...
      description:'The World Health Organization had just declared COVID-19...'
    },
   
    {
      ...
      description:'Much of the world is starting to open up again, with many countries easing or planning to ease coronavirus  ...'
    }
  ]; 
  constructor() { }
  ngOnInit(): void {
